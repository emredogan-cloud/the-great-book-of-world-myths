...
| Alan | Değer |
|---|---|
| HEDEF | KDP hardcover · case laminate wrap (14.349×10.417 in) |
| ORAN | 14.349:10.417 (landscape wrap) |
| ÖLÇÜ (inç) | 14.349 × 10.417 |
| ÜRETİM (px) | 4116 × 3075 |
| TİPOGRAFİ | SONRADAN BASILIR |
...
- outer 0.591" on every edge — WRAP, folds around the board and is not seen; no subject may sit there
- 0.394" either side of the spine — HINGE, creases in binding

```
the same wrap-around world-horizon scene, landscape 14.349×10.417 inches, but composed with a wider safety margin: every important element must sit at least 0.985 inches inside the outer edge, because the outer band folds around the board and the band beside the spine creases into the hinge. Extend background colour and sky all the way to the edge so the fold shows no white. full-colour children's book cover illustration, ages 8 to 12, warm and inviting, bright saturated palette with a clear focal point, characterful stylised figures with friendly readable faces, storybook poster composition rather than a busy collage, strong silhouette that still reads when the image is one inch wide. Suitable for readers aged 8 to 12: the image may be dramatic, it may not be frightening.
```
