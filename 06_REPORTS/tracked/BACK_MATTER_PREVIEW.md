...
| **anansesem** | ah-nahn-SEH-sem | Akan |
| **angakkuq** | ah-NGAH-kook | Inuit |
| **Aodh** | AY | Irish |
| **Aoife** | EE-fuh | Irish |
| **Aotearoa** | ah-oh-teh-ah-ROH-ah | Māori |
| **Arachne** | uh-RAK-nee | Greek |
| **Asadal** | AH-sah-dahl | Korean |
| **Ásgarðr** | OWS-garth | Norse |
| **Aso** | AH-saw | Akan |
| **Athena** | uh-THEE-nuh | Greek |
| **Âu Cơ** | oh KUH | Vietnamese |
...
| **Culann** | KUL-un | Irish |
| **Daedalus** | DED-uh-lus | Greek |
| **Dangun** | DAHN-goon | Korean |
...
| **Etana** | eh-TAH-nah | Mesopotamian |
| **Fenrir** | FEN-rir | Norse |
| **Fereydun** | feh-ray-DOON | Persian |
| **Fionnuala** | fin-OO-uh-luh | Irish |
| **Freyja** | FRAY-uh | Norse |
| **Gaṅgā** | GUNG-gah | Hindu |
| **Geumwa** | GUM-wah | Korean |
| **Gilgamesh** | GIL-guh-mesh | Mesopotamian |
| **Gleipnir** | GLAYP-nir | Norse |
| **Goguryeo** | go-GOO-ryuh | Korean |
| **Gojoseon** | GO-jo-son | Korean |
| **Gonggong** | GUNG-gung | Chinese |
...
| **Hiʻiaka** | hee-ee-AH-kah | Hawaiian |
| **Horus** | HOR-us | Ancient Egyptian |
...
| **Icarus** | IK-uh-rus | Greek |
| **Idun** | IH-thoon | Norse |
| **Ilé-Ifẹ̀** | ee-LEH ee-FEH | Yoruba |
...
| **Kāveh** | KAW-veh | Persian |
| **Kīlauea** | KEE-lau-EH-ah | Hawaiian |
| **Kish** | KISH | Mesopotamian |
...
| **Nut** | NOOT | Ancient Egyptian |
| **Nüwa** | NYOO-wah | Chinese |
| **Nyame** | NYAH-meh | Akan |
| **Ọbàtálá** | aw-bah-TAH-lah | Yoruba |
| **Odin** | OH-din | Norse |
...
| **Papatūānuku** | PAH-pah-too-ah-noo-koo | Māori |
...
| **Tản Viên** | tahn VEE-en | Vietnamese |
| **Tāne** | TAH-neh | Māori |
| **Tāwhirimātea** | TAH-fee-ree-MAH-teh-ah | Māori |
| **Te Ika-a-Māui** | teh EE-kah ah MAH-oo-ee | Māori |
| **Tecuciztecatl** | teh-koo-sees-TEH-kahtl | Aztec (Mexica) |
| **Teotihuacan** | teh-oh-tee-WAH-kahn | Aztec (Mexica) |
| **Tepegöz** | TEH-peh-gurz | Turkic |
| **Tepew** | teh-PEW | Maya |
| **Thor** | THOR | Norse |
| **Thrym** | THRIM | Norse |
...
| **Uruk** | OO-rook | Mesopotamian |
| **Utnapishtim** | oot-nah-PISH-tim | Mesopotamian |
| **Väinämöinen** | VY-nah-moy-nen | Finnish |
| **Vāyu** | VAH-yoo | Hindu |
| **Wiraqucha** | wee-rah-KOH-chah | Andean |
| **Xbalanque** | shbah-lahn-KEH | Maya |
...
| **Basat** | — | A boy raised by a lioness who comes back to his people | The One-Eyed Giant of the Oghuz |
...
| **Nüwa** | Nügua | Who repairs the world when it breaks | The Woman Who Patched the Sky |
| **Nyame** | Onyame | The sky god, who owns them now | How the Stories Got Their Name |
| **Ọbàtálá** | Obatala, Òrìṣà-ńlá | Sent down to make dry land out of water | The Chain Let Down from the Sky |
| **Odin** | Óðinn | Who knows how this ends and does it anyway | The Ribbon That Held a Wolf |
...
| **Tāwhirimātea** | Tāwhiri | The child who never agrees to it | The Children Who Pushed Their Parents Apart |
| **Te Ika-a-Māui** | — | The fish, which is now the North Island | The Fish That Became an Island |
| **Tecuciztecatl** | Tecciztecatl | The rich god who was supposed to go first | The Small God Who Jumped First |
| **Tepegöz** | — | A giant with one eye in the middle of his forehead | The One-Eyed Giant of the Oghuz |
| **Tepew** | Tepeu | One of the makers | Made of Mud, Wood, and Finally Maize |
| **The angakkuq** | — | The one who has to go down and comb her hair | The Woman at the Bottom of the Sea |
| **The boy** | — | Blind, and better at listening than anyone realises | The Boy Who Got His Eyes Back |
| **The Eagle** | — | Who swears friendship and then breaks it | The Eagle and the Snake Who Swore an Oath |
| **The llama** | — | Who knows what is coming and will not say it politely | The Llama That Would Not Eat |
| **The loon** | — | Who takes him down and holds him under | The Boy Who Got His Eyes Back |
| **The red ant** | — | Who knows, and does not want to say | The Ant Who Would Not Say Where |
| **The sailor** | — | The only survivor of his ship, telling the story to calm someone else | The Island That Was Not There Afterwards |
| **The serpent** | — | Thirty cubits long, with a beard, and entirely alone | The Island That Was Not There Afterwards |
| **The Snake** | — | Who keeps the oath and is wronged | The Eagle and the Snake Who Swore an Oath |
...
> Her kültürün üç cümlesi **kültür kartı metnidir** ve okura gövdede,
> o kültürün ilk hikâyesinin kuyruğunda görünür (karar K27). Burada
> önizleme amacıyla bir arada listelenir.

### Africa

- **Akan** — Ghana, Côte d’Ivoire · 2 stories · map: Asante and the Akan lands
  - *Twi*
  - These are told out loud, at night, by anybody who can hold a room, and the audience interrupts with songs.
  - Ghana and eastern Côte d’Ivoire, in forest country where the spider in the story is one you can meet on a wall.
  - Anansi stories are still told and still published, and the Caribbean versions are related to them but are not the same stories.
- **Ancient Egyptian** — Nile valley · 3 stories · map: The Nile valley
  - *Ancient Egyptian*
  - These come from papyrus rolls, and several survive in a single copy, so what reaches us depends on which roll did not rot.
  - The Nile valley and the Red Sea coast, in a country whose whole shape is one river with desert on both sides.
  - The religion ended long ago and the writing stayed unreadable for fifteen centuries, until a soldier turned up a slab with three scripts on it.
- **Yoruba** — Yorubaland (southwestern Nigeria, Benin) · 2 stories · map: Yorubaland
  - *Yorùbá*
  - Named narrators and diviners told these to collectors in the twentieth century, and Yoruba scholars have been writing about their own tradition ever since.
  - Yorubaland — Ilé-Ifẹ̀, Òṣogbo and the towns around them — and, after the slave trade, cities on the far side of the Atlantic.
  - Òrìṣà devotion continues in Nigeria, Brazil and Cuba, and the yearly festival at Òṣogbo fills a protected grove beside the river.
- **Zulu** — KwaZulu-Natal, southern Africa · 1 story · map: KwaZulu-Natal
  - *isiZulu*
  - These belong to a named genre, inganekwane, told mostly by older women to children, with a formal opening the children answer.
  - KwaZulu-Natal: grassland, cattle country, and the hills between the Drakensberg and the Indian Ocean.
  - isiZulu has more first-language speakers than any other language in South Africa, and these tales are printed in school readers in it.

### Central Asia and the Steppe

- **Turkic** — Oghuz lands, Anatolia, Central Asian steppe · 2 stories · map: The Oghuz lands
  - *Oghuz Turkic*
  - A storyteller called Dede Korkut frames every tale, arriving at the end to give a name and a blessing.
  - The Oghuz lands: grazing country between the Caspian and Anatolia, told among people who moved with their herds.
  - Turkey, Azerbaijan and Turkmenistan all claim these tales, teach them in school, and disagree publicly about who owns the storyteller.

### East Asia

- **Chinese** — China · 2 stories · map: The Central Plain
  - *Classical Chinese*
  - Philosophers and court compilers preserved these while arguing about something else, so the earliest versions are often footnotes to another subject.
  - The Central Plain and the Yellow River, in a country where the flood stories are about real floods that arrive on a schedule.
  - The moon story runs the Mid-Autumn Festival, and hundreds of millions of people eat mooncakes under it without needing the plot explained.
- **Japanese** — Japanese archipelago · 2 stories · map: Ise and the islands
  - *Japanese*
  - Two eighth-century compilations record these, and the second deliberately prints several competing versions side by side rather than choosing.
  - Takamagahara for the gods, and for the rest, real geography: Izumo, a river, and shrines reachable on an ordinary train.
  - Shinto is practised now. The shrine at Ise comes down and goes up again every twenty years, and the next rebuilding has a date.
- **Korean** — Korean peninsula · 2 stories · map: Korean peninsula
  - *Korean*
  - A monk called Iryeon compiled these in 1281, and he says when he is copying an older book he can no longer show you.
  - The peninsula and the country north of it: pine mountains, river crossings, and walled towns founded by people the stories name.
  - Korea marks one of these founding accounts with a national holiday every October, and the archery story reaches television most years.

### Europe

- **Finnish** — Finland and Karelia · 2 stories · map: Karelia
  - *Finnish*
  - A country doctor spent years walking through eastern villages writing down what singers sang, then arranged the pieces into one long poem.
  - Karelia, on both sides of a border that has moved several times, in forests where the lakes go on for a hundred kilometres.
  - The singing mostly stopped, but the poem became the national epic, and Finland keeps a public holiday for it in February.
- **Greek** — Aegean, Hellas · 3 stories · map: Hellas
  - *Ancient Greek*
  - Poets wrote these down early and often, and the versions that reached us are the ones people kept copying.
  - They belong to the Aegean: islands, harbours, olive terraces, and a sea you can cross in a small boat.
  - Nobody makes offerings to these gods now, but the names are everywhere — on maps, in medicine, in the word for panic.
- **Irish** — Ireland · 2 stories · map: Ireland
  - *Irish*
  - Monks copied these into large books between the eleventh and fifteenth centuries, and their handwriting is why anything survives.
  - Ulster, Connacht, and the coast of Mayo, in places you can drive to, several of which have a road sign about the story.
  - Ireland teaches these in school and argues about them in pubs, and the swans of one of them hold a preservation order.
- **Norse** — Scandinavia, Iceland · 3 stories · map: Iceland and the North
  - *Old Norse*
  - Two Icelandic books carry most of what survives, and one was written by a politician who wanted poets to keep understanding the old images.
  - Iceland, Norway, and the cold coastlines between, where winters are dark enough to make a story about the sun being eaten sound reasonable.
  - The old worship ended a thousand years ago. The poems did not, and four days of the English week still carry these names.

### Mesoamerica

- **Aztec (Mexica)** — Valley of Mexico · 2 stories · map: The Valley of Mexico
  - *Nahuatl*
  - Nahua elders dictated these to scribes after the conquest, in Nahuatl, and the young men writing them down were their own students.
  - The Valley of Mexico: a lake with a city built out into it, ringed by volcanoes the stories still name.
  - Around a million and a half people speak Nahuatl, and the sun of this account is carved at the centre of the famous stone.
- **Maya** — K’iche’ highlands, Guatemala · 2 stories · map: The K'iche' highlands
  - *K’iche’*
  - One book carries the central narrative, written in K’iche’ in the sixteenth century by people setting down what they already knew.
  - The highlands of Guatemala, and Xibalba, which is under the ground and is reached through a cave.
  - More than a million people speak K’iche’, the book is a school text, and the ball game it describes is played again in several towns.

### Oceania

- **Hawaiian** — Hawaiian archipelago · 2 stories · map: Hawaiʻi
  - *ʻŌlelo Hawaiʻi*
  - Chanters carried these in memory, and in the nineteenth century Hawaiian writers printed them in Hawaiian-language newspapers to keep them.
  - The archipelago, and in particular the volcano country of Hawaiʻi island, where the fire goddess is said to be living now.
  - Offerings are left at Kīlauea today, ʻōlelo Hawaiʻi is being taught to a new generation of speakers, and hula schools still chant these lines.
- **Māori** — Aotearoa (New Zealand) · 2 stories · map: Aotearoa
  - *Te reo Māori*
  - These are held by iwi, and different iwi tell them differently on purpose; whakapapa decides who may tell which part.
  - Aotearoa, and the ocean crossed to reach it — the North Island is the fish in one of these stories.
  - Te reo Māori is an official language, taught in schools and broadcast daily, and Māui appears in films made by Māori film-makers.

### South America

- **Andean** — Huarochirí, Peruvian Andes · 1 story · map: Huarochirí
  - *Quechua*
  - A single manuscript, taken down in Quechua around 1600 from people in one province, holds nearly everything that survives of this.
  - Huarochirí, in the mountains above Lima, where the villages sit at heights that leave visitors short of breath.
  - Quechua is spoken by millions across the Andes, and the herders in these stories have descendants doing the same work on the same slopes.

### South Asia

- **Hindu** — Indian subcontinent · 2 stories · map: The Ganges plain
  - *Sanskrit*
  - Two vast epics carry most of these, and neither has one author or one version; reciters shaped them over centuries and shape them still.
  - The subcontinent, from the Himālaya to the southern forests, along rivers whose names appear in the stories and on modern maps unchanged.
  - This is living religion. Hanumān has temples in most Indian towns, and Tuesday is his day in many of them.

### Southeast Asia

- **Vietnamese** — Red River delta, northern Vietnam · 2 stories · map: The Red River delta
  - *Vietnamese*
  - A fifteenth-century collection of strange tales holds the narrative, and the official court chronicle records the same events as history.
  - The Red River delta and the mountains behind it — rice country that floods every summer, exactly as the story says it does.
  - The founding kings have a national holiday every spring, and enormous crowds climb the hill at Phú Thọ in the heat to mark it.

### The Arctic

- **Inuit** — Greenland, Nunavut, Alaska · 2 stories · map: Nunavut and Greenland
  - *Inuktitut*
  - Elders tell these, and much of what is written down was recorded by people who were told carefully what could not be repeated.
  - Across the Arctic — Greenland, Nunavut, Alaska — over a distance greater than the width of Europe.
  - Inuit communities govern themselves in Nunavut and Greenland, and the sea-woman story is taught in their own schools in their own language.

### West Asia

- **Mesopotamian** — Sumer, Akkad, Babylon · 2 stories · map: Between the rivers
  - *Sumerian and Akkadian*
  - Scribes pressed these onto clay tablets four thousand years ago as school exercises, which is precisely why so many broken copies exist.
  - The flat country between the Tigris and the Euphrates: irrigation ditches, mud-brick cities, and the oldest writing anybody has found.
  - No one has spoken these languages for two thousand years. The tablets are readable again because scholars spent a century learning how.
- **Persian** — Iranian plateau · 2 stories · map: Iranian plateau
  - *Persian*
  - One poet spent about thirty years assembling these into a single enormous verse history, and he says so himself, at length, inside it.
  - The Iranian plateau — Alborz, Zabulistan, and the cities along the roads that crossed it.
  - Iranians recite this poem now, in the same language, and professional reciters perform it to audiences who know when to join in.

*22 of 22 cultures locked.*
...
- **"African mythology" as a single category** — Arka maddede okura söylenir: bu kitapta 'Afrika miti' diye bir bölüm YOKTUR, çünkü öyle bir şey yoktur.
