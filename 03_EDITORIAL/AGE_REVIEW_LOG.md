...
| 35 | `inuit-sedna` | `cleared` | **Anlatının merkezi çıkarılamaz ve çıkarılmadı** (§ 2.1). Parmakların kayışı **tek cümle**: "Her fingers came off against the wood, and she went down." Yara betimlenmiyor; sahne **dönüşümdür** — eklemler foka, mors ve balinaya dönüşürken anlatı oraya geçiyor. Baba **aklanmıyor**: kaynakta olmayan bir barışma veya açıklama eklenmedi ve tellerlerin uzlaştırmadığı şey uzlaştırılmadı. Angakkuq'un yolculuğunun **tekniği anlatılmadı** (§ 2.16) ve neden anlatılmadığı okura söylendi. Inuit toplulukları **şimdiki zamanda** anılıyor (§ 2.15). |
| 36 | `inuit-blind-boy-loon` | `cleared` | **İSTİSMAR — § 2.9 OMIT seviyesi, ve korunma gerekçesi yazılı.** Kör bir çocuğun aç bırakılması ve kandırılması anlatının **yargıladığı** haksızlıktır: iki cümlede söyleniyor, hiçbir yerde sahnelenmiyor, ve **hak edilmiş olarak çerçevelenmiyor**. İntikam § 2.12 uyarınca **söyleniyor ama alkışlanmıyor** — "The story does not applaud it" cümlesi metnin içinde duruyor ve çocuğun mutlu olduğu bir sahne **yok**. Kız kardeşin iyiliği anlatının tek sıcak yeri olarak korundu. |
| 37 | `maya-hero-twins` | `cleared` | **Ölüm ve doğaüstü korku** (§ 2.2 ALLOW, § 2.1, § 2.17). İkizler birden fazla kez ölüyor ve bu **saklanmıyor**; öldürmeler **sonuçlarıyla** veriliyor. Bıçak, soğuk ve yarasa evleri **yaptıklarıyla** anlatılıyor, içerikleriyle değil. Sondaki hile — lordların kendilerini öldürtmesi — **korundu**, çünkü anlatının bütün ağırlığı orada. Aj q'ij günsayıcılığı, takvim divinasyonu ve topluluk-özel kutsal alan bilgisi **kullanılmadı**. K'iche' halkı ve dili şimdiki zamanda. |
| 38 | `maya-maize-people` | `cleared` | **Korkutucu imge ve ölüm** (§ 2.17, § 2.2). Tahta insanların yok edilişi **söyleniyor**, saldırı sahnelenmiyor: ev eşyalarının şikâyeti dört kısa cümlede veriliyor ve orada bırakılıyor. Önceki iki denemenin **başarısızlığı korundu** — yaratıcıların hata yapmadığı bir yaratılış anlatısı başka bir anlatıdır. Gözlerin bulandırılması bir ceza olarak değil, bir **ölçü** olarak çerçevelendi. |
| 39 | `aztec-fifth-sun` | `cleared` | **KURBAN — bu kitabın en zor yaş kararı** (§ 2.7 IMPLY + inceleme, § 0.3). Ateşe giriş **tek cümle**: "He shut his eyes and ran and went into the middle of the fire." Hiçbir tören betimlenmedi, hiçbir kalabalık yok, ve § 2.7'nin çerçeveleme kuralı belirleyici oldu: anlatı bunu **gösteri** olarak değil **borç** olarak veriyor — "The sun moves because it was paid for." *"Onlar böyleydi"* cümlesi § 0.3 uyarınca **mutlak yasak** ve metinde hiçbir biçimi yok; tersine, "Nobody in the account enjoys any of it" cümlesi metnin içinde duruyor. Nanahuatzin'in hastalığı aşağılanma değil **nitelik** olarak kuruldu. |
| 40 | `aztec-quetzalcoatl-maize` | `cleared` | **Hiçbir kategori taşımıyor** ve bu bilinçli bir yerleştirmedir: Beşinci Güneş'ten hemen sonra konuldu. Mexica kaydı yalnızca bedel üzerine değildir ve yalnızca en zor anlatısını alan bir kitap o kaydı **yanlış temsil eder**. Karınca dört kez reddediyor ve hiçbir noktada yardım etmeye razı olmuyor — anlatının mizahı ve inadı korundu. |
| 41 | `andean-llama-flood` | `cleared` | **Ölüm** (§ 2.2 ALLOW). Tırmanmayan her şeyin yok oluşu **tek cümlede** söyleniyor ve betimlenmiyor; kaynak da öyle yapıyor. Kaynakta olmayan hiçbir teselli **eklenmedi** — adam için bir avuntu sahnesi yok ve hikâye ona ad bile vermiyor. Despacho/pago ritüel prosedürü ve topluluk-özel apu bilgisi **kullanılmadı**. Quechua ve Quechua konuşanlar şimdiki zamanda. |
| 42 | `maori-maui-fish` | `cleared` | **Şiddet** (§ 2.1 · IMPLY). Māui'nin burnuna vurup oltayı kanla yemlemesi **tek cümle** ve betimlenmiyor. Kardeşlerin balığı kesmesi **karaya verilen hasar** olarak anlatılıyor, bir canlıya işkence olarak değil; sonucu adanın şekli. Anlatım çokluğu kapanışta **açıkça** söylendi: Māui anlatıları iwi'den iwi'ye değişir, tek doğru anlatım yoktur ve kimse öyle bir şey yapmaya çalışmadı. Iwi/hapū whakapapa, karakia, tā moko anlamları ve wāhi tapu **kullanılmadı**. |
| 43 | `maori-rangi-papa` | `cleared` | **Yas ve savaş** (§ 2.3, § 2.11). Ayrılık **kalıcıdır ve onarılmadı**: Ranginui'nin yağmuru durmuyor, Papatūānuku'nun sisi her sabah kalkıyor ve hiçbir anlatım bunu bir kavuşmaya çevirmedi. Tāwhirimātea'nın kardeşlerine açtığı savaş **söyleniyor, sahnelenmiyor**. Kardeşlerden birinin "onları öldürelim" önerisi **saklanmadı** — Tāne'nin ona karşı çıkışı anlatının ahlaki merkezi. |
| 44 | `hawaiian-maui-sun` | `cleared` | **Hiçbir kategori taşımıyor** ve kitapta tam da bu yüzden duruyor: uyarlama varsayılan değildir. Kaynağın hiçbir şeye ihtiyacı yoktu ve hiçbir şey yapılmadı. Güneşin bağlanması bir zafer olarak değil **anlaşma** olarak kuruldu. ʻAumakua ilişkileri, heiau ritüeli, tam oli/mele metinleri ve kahuna pratiği **kullanılmadı**. |
| 45 | `hawaiian-pele-journey` | `cleared` | **Yaşayan din + doğaüstü korku** (§ 2.15, § 2.17). Pele **şimdiki zamanda** anılıyor ve bir batıl inanç olarak sunulmuyor; inancın doğruluğu hakkında hiçbir iddia yok. Ateşin yıkıcılığı **manzarayla** veriliyor: yollar kapanır, evler kaybedilir. Hiçbir ölüm sahnelenmiyor. Kīlauea'ya bugün bırakılan adaklar **olgu olarak** anılıyor ve **prosedürü anlatılmıyor** — metin bunu okura açıkça söylüyor (§ 2.16). Pele–Hiʻiaka destanı **özetlenmedi**: 950 kelimeye sıkıştırmanın ona zarar vereceği söylendi ve yalnızca işaret edildi. |
